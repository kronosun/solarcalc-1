            ...
            <div className="Calculator">
              ...
              <div className="calc-pricing--container">
                ...
                <div className="calc-inputs">
                  ...
                  <div className="calc-input">
                    <label htmlFor="electricBill">
                      Current Avg Electric Bill $
                    </label>
                    <input
                      value={electricBill}
                      onChange={(e) => {
              ...
              {isLoading ? (
                ...
                <React.Fragment>
                  <div className="calc-details">
                    <p>
                      Total System Price: ${totalSystemPrice.toLocaleString()}
                    </p>
                    <p>
                      Estimated Remaining Electric Bill (Excluding Connection
                      Fees): ${remainingBill}
                    </p>
                  </div>
          ...
          <Switch>
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[0].termLength}
                  powerBill={electricBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[0].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[1].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[1].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[2].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  interest={financingList[2].interestRate}
                  systemSize={systemSize}
                  offset={offset}
                />
              )}
            ...
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[3].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[3].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[4].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[4].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[5].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[5].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[6].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[6].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[7].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[7].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[8].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[8].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[9].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[9].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[10].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[10].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[11].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[11].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[12].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[12].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[13].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[13].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[14].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[14].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[15].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[15].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[16].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[16].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[17].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[17].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[18].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[18].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[19].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[19].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[20].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[20].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[21].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[21].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[22].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[22].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[23].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[23].interestRate}
                  offset={offset}
                />
              )}
            />
            <Route
              ...
              render={(props) => (
                <MonthlyFinance
                  {...props}
                  termLength={financingList[24].termLength}
                  powerBill={remainingBill}
                  totalSystemPrice={totalSystemPrice}
                  systemSize={systemSize}
                  interest={financingList[24].interestRate}
                  offset={offset}
                />
              )}
            />
